...
[ -z "$ARCUBE_NDLARSIM_PIXEL_LAYOUT" ] && export ARCUBE_NDLARSIM_PIXEL_LAYOUT="larnd-sim/larndsim/pixel_layouts/multi_tile_layout-2.3.16.yaml"
...
[ -z "$ARCUBE_NDLARSIM_LIGHT_DET_NOISE_FILENAME" ] && export ARCUBE_NDLARSIM_LIGHT_DET_NOISE_FILENAME="larnd-sim/larndsim/bin/light_noise-2x2-example.npy"
