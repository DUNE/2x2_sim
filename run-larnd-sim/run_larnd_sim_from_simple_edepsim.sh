...
inDir=${ARCUBE_OUTDIR_BASE}/run-convert2h5/
inName=$1
inFile=$(realpath $inDir/TEST_FAKE_EDEPSIM_H5/$subDir/${inName}.hdf5)
...
export ARCUBE_LARNDSIM_CONFIG=2x2
...
mkdir -p "$outDir/TEST_LARNDSIM/$subDir"
mv "$outFile" "$outDir/TEST_LARNDSIM/$subDir"
