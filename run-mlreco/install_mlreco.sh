...
git clone -b mjkramer/feature/trigger_times https://github.com/DeepLearnPhysics/flow2supera.git
...
git clone -b spine https://github.com/DeepLearnPhysics/spine.git
