...
export ARCUBE_EXPOSURE=4E14
export ARCUBE_GEOM=geometry/Merged2x2MINERvA_withRock_zincEdit_onlyActiveLArSens_v3.gdml
...
for ntasks in 64 128 192 256; do
    export ARCUBE_OUT_NAME=NuMI_RHC_withRock_${ntasks}tasks
